from receiver_mappings import DualMapping
...
disable_connections_dual = {mapping: {"activation": {"mode": "activate_immediate"}, "master_enable": False} for
                            mapping in DualMapping}
