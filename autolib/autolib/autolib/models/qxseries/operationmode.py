...
@enum.unique
class OperationMode(DeviceCapability):
    """
    A DeviceCapability used to request operation mode capabilities from Qx series devices. A special value 'CURRENT'
    ...
    COMBINED_SDI_IP = OperationModeEntry(13, 6)
